...
namespace Lab11_
{
    class CEmblem
    {
        ...
        {
            Rectangle circl = new Rectangle(X - 289, Y, 2 * Radius, 2 * Radius);
            graphics.DrawEllipse(pen, circl);

            Rectangle cube = new Rectangle(X - 99, Y, Radius * 2, Radius * 2);
            graphics.DrawRectangle(pen, cube);

            double r = (Radius);
            Point p1 = new Point((X - 144) - (int)(r * Math.Cos(Math.PI / 6)), (Y + 132) - (int)(r * Math.PI / 6) - Radius * 2);
            Point p2 = new Point((X - 144)  - (int)(r * Math.Cos(Math.PI / 6)), (Y + 145)  + (int)(r * Math.PI / 3) - Radius * 2);
            Point p3 = new Point((X - 144) + (int)(r * Math.Cos(Math.PI / 6)), (Y + 132) + (int)(r * Math.PI / 7) - Radius * 2);
